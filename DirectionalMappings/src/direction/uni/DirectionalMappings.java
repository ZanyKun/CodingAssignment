...
public class DirectionalMappings {
	...
	public static void main(String... args) {
		...
		//Unidirectional OneToOne Mapping
			...
			Passport v1 = new Passport("Honduras", Arrays.asList("Japan", "United States"));
			Passport v2 = new Passport("Vietnam", Arrays.asList("United States"));
		...
		//Unidirectional ManyToOne Mapping
		...
		//Unidirectional ManyToMany Mapping
